...
export function FilterBar({
  ...
  return (
    <div className={cn("card flex flex-wrap items-stretch gap-2.5 p-3 sm:items-center", className)}>
      {children}
    </div>
  );
}
...
export function SearchInput({
  ...
  return (
    <div className={cn("relative min-w-0 flex-1 sm:min-w-[180px]", className)}>
